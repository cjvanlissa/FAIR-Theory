...
::: {.incremental}
- theories use a formal, accessibleessible, shared, and broadly applicable language for knowledge representation.
...
::: {.incremental}
- theories are released with a clear and accessibleessible usage license
